// Blog content. Each post generates its own prerendered HTML shell at build time
...
export const posts = [
  {
    ...
    description:
      'Oikos is the Greek word for household, but in the New Testament it means far more than the people under your roof. Here is what it meant then, and what it means for you now.',
    date: '2026-07-30',
    readingTime: '6 min read',
    tags: ['Oikos', 'Bible study', 'Evangelism'],
    kicker: 'Start here',
    excerpt:
      'The word appears more than a hundred times in the New Testament, and it quietly explains how the early Church grew so fast.',
    intro: [
    ...
    network: ['ThyKingdom.net', 'LoveonTheWorld.com', 'IAmReborn.net'],
    cta: { text: 'Map your oikos free', url: '/#builder' },
  },

  {
    ...
    description:
      'A five-minute daily rhythm for praying by name for the people you love who do not yet follow Jesus — including what to pray when it has been years.',
    date: '2026-07-30',
    readingTime: '7 min read',
    tags: ['Prayer', 'Family', 'Perseverance'],
    kicker: 'Step one · Pray',
    excerpt:
      'Most of us do not stop praying for the people we love because we lack faith. We stop because we never had a rhythm.',
    intro: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['Once a day, ideally at the same moment — commute, kettle, lunch break:'],
        list: [
    ...
    network: ['LoveonTheWorld.com', 'JesusFestival.app', 'KD-Ziedins.com'],
    cta: { text: 'Build your prayer list', url: '/#builder' },
  },

  {
    ...
    description:
      'A simple three-part framework for telling your story of coming to faith — clearly, honestly, and short enough that people actually listen.',
    date: '2026-07-30',
    readingTime: '6 min read',
    tags: ['Testimony', 'Evangelism', 'Practical'],
    kicker: 'Step three · Share',
    excerpt:
      'You are not the expert witness on theology. You are the eyewitness on your own life, and nobody can cross-examine that.',
    intro: [
    ...
    network: ['JesusFestival.ca', 'JesusFestivalMovement.com', 'SIX33Outpost.com', 'SIX33Legends.com'],
    cta: { text: 'See who to share with', url: '/#builder' },
  },

  {
    ...
    description:
      'Twelve ordinary, non-awkward ways to move toward the people around you — the practical middle ground between praying for someone and preaching at them.',
    date: '2026-07-30',
    readingTime: '5 min read',
    tags: ['Care', 'Neighbours', 'Practical'],
    kicker: 'Step two · Care',
    excerpt:
      'Almost nobody changes their mind about Jesus because they lost an argument. They change because someone loved them in a way that did not add up.',
    intro: [
    ...
    network: ['LoveonHamilton.com', 'KingdomResponse.com', 'JesusFestival.app', 'LoveonTheWorld.com'],
    cta: { text: 'Pick one person to start with', url: '/#builder' },
  },

  {
    ...
    description:
      'The early Church grew from a few thousand to millions without buildings, budgets, or public platforms. Households were the engine — and the method still works.',
    date: '2026-07-30',
    readingTime: '8 min read',
    tags: ['Church history', 'Multiplication', 'Discipleship'],
    kicker: 'The bigger picture',
    excerpt:
      'No buildings, no budget, no legal standing, and frequently illegal. And it kept spreading. The mechanism is not a mystery.',
    intro: [
    ...
    network: ['LoveonMission.world', 'ThyKingdom.net', 'SeekFirst.World'],
    cta: { text: 'Map your household network', url: '/#builder' },
  },

  {
    ...
    description:
      'You spend more waking hours with colleagues than with almost anyone else. Here is how to be a genuine witness at work without becoming the person everyone avoids.',
    date: '2026-07-30',
    readingTime: '7 min read',
    tags: ['Work', 'Culture', 'Integrity'],
    kicker: 'Where you already are',
    excerpt:
      'Roughly 90,000 hours over a working life, with the same group of people. It is the largest mission field most Christians have, and the one we think about least.',
    intro: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['In a workplace, these are the things people register over months:'],
        list: [
    ...
    cta: { text: 'Add your colleagues to your map', url: '/#builder' },
  },
];
...
// Explicit ordering: all six published together, so date cannot decide the
// featured slot. The cornerstone article leads.
